...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 offset-md-3 mt-2 bg-light border">
                    ...
                    <form action="{{ route('blogs.update', $blog->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            rows="3">{{ old('description') ? old('description') : $blog->description }}</textarea>
                        </div>
                        @error('description')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        ...
                        @error('author')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        <button class="btn btn-primary w-25 mt-2 mb-2" type="submit">Submit</button>
                    </form>
                </div>
            </div>
        </div>
